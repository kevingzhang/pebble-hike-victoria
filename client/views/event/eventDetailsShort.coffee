Template.eventDetailsShort.events
    'click .rsvp_yes': ()->
...
Template.eventDetailsShort.helpers
    posterName: () ->
...
Template.eventDetailsShort.selectedEvent = () ->
    return Events.findOne(Session.get("selected"))


Template.eventDetailsShort.anyEvents = () ->
    return Events.find().count() > 0


Template.eventDetailsShort.creatorName = () ->
...
Template.eventDetailsShort.canRemove = () ->
  return this.owner == Meteor.userId() and attending(this) == 0


Template.eventDetailsShort.maybeChosen = (what) ->
